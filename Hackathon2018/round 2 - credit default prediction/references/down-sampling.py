# -*- coding: utf-8 -*-
"""
Created on Sat Mar 31 13:13:56 2018
...
# deal with imbalanced class downsampling majority class
...
df_majority_downsampled = resample(df_majority, 
                                 ...
                                 n_samples=80,     # to match minority class
...
X=df_downsampled[['Gross Profit','Revenue','Pretax Income','Total Assets','Total Liabilities','Total Current Assets','Total Current Liabilities','Inventories','Interest Expense','Short-Term Borrowings','Cash & Near Cash Items','Accounts & Notes Receivable']]
...
#Train 
clf_2 = LogisticRegression(class_weight='balanced').fit(X_train, y_train)
...
#summary
params = np.append(clf_2.intercept_,clf_2.coef_)
