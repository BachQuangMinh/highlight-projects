# -*- coding: utf-8 -*-
"""
Created on Tue May  8 17:16:30 2018
...
df.replace('?',10**9,inplace=True) #fill missing values with an outlier
...
comparetrain = pd.DataFrame({'y train': y_train, 'train label': y_train_pred}) #train shows pretty good results
